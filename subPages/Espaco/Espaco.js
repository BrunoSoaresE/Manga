...
export function SubPageEspaco(props) {
  return (
    <div type="button" className={styles.espaco}>
      ...
      <ul className={styles.espacoUL}>
        <li className={styles.espacoLI}>
          <div className={styles.espacoTexto}>
            <h3 className={styles.espacoTitulo}>“A melhor forma de prever o futuro é criá-lo”<br></br><span>Peter F. Drucker</span></h3>
